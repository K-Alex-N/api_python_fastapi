...
class TestLogin:
    ...
    async def test_successful_login_async(self, login_page: LoginPage) -> None:
    ...
    async def test_failed_login_with_invalid_username_async(self, login_page: LoginPage) -> None:
    ...
    async def test_failed_login_with_invalid_password_async(self, login_page: LoginPage) -> None:
